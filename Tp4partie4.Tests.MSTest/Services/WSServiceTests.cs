...
namespace Tp4partie4.Services.Tests
{
    ...
    public class WSServiceTests
    {
            ...
            List<Utilisateur> utilisateurs = new List<Utilisateur>()
        {
            ...
            var result = service.GetAllUtilisateursAsync().Result;
        ...
        //    var result = service.SearchUtilisateurAction("GetById", 3).Result;
        ...
        public void GetAsyncTest_ExistingEmailPassed_ReturnsRightItem()
        {
            ...
            var result = service.GetByEmailAsync("rrichings1@naver.com").Result;
        ...
        //{
        //    WSService service = new();
        //    TestActionException_StatusCode(() => { var result = service.GetByIdAsync("GetById", 300_000).Result; }, HttpStatusCode.NotFound);
        //}
        ...
        {
            WSService service = new();
            TestActionException_StatusCode(() => { var result = service.GetByEmailAsync("rrichings120@naver.com").Result; }, HttpStatusCode.NotFound);
        }
        ...
        public void PostAsyncTest_ValidModel_ReturnsRightItem()
        {
            ...
            var result = service.PostUtilisateurAsync(utilisateur).Result;
        ...
        public void PostAsyncTest_InvalidModel_ReturnsErrorBadRequest()
        {
            ...
            TestActionException_StatusCode(() => { var result = service.PostUtilisateurAsync(utilisateur).Result; }, HttpStatusCode.NotFound);
        }
        ...
        public void PutAsyncTest_ValidId_ValidModel_ReturnsNoError()
        {
            ...
            service.PutUtilisateurAsync(3, utilisateur).Wait();
        }
        ...
        public void PutAsyncTest_ValidId_InvalidModel_ReturnsErrorBadRequest()
        {
            ...
            TestActionException_StatusCode(() => { service.PutUtilisateurAsync(3, utilisateur).Wait(); }, HttpStatusCode.NotFound);
        }
        ...
        public void DeleteAsyncTest_ExistingIdPassed_ReturnsNoError()
        {
            ...
            service.DeleteUtilisateurAsync(result.UtilisateurId).Wait();
        }
        ...
        {
            WSService service = new();
            TestActionException_StatusCode(() => { service.DeleteUtilisateurAsync(300_000).Wait(); }, HttpStatusCode.NotFound);
        }
