...
using Tp4partie4.Core.Services;
using Tp4partie4.Helpers;
using Tp4partie4.Models;
using Tp4partie4.Services;
using Tp4partie4.ViewModels;
using Tp4partie4.Views;

namespace Tp4partie4;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<AutresViewModel>();
            services.AddTransient<AutresPage>();
